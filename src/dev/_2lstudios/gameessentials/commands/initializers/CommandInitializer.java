...
import dev._2lstudios.gameessentials.commands.KitPreviewCMD;
import dev._2lstudios.gameessentials.commands.KitCMD;
...
import dev._2lstudios.gameessentials.commands.DeleteKitCMD;
import dev._2lstudios.gameessentials.commands.CreateKitCMD;
...
public class CommandInitializer {
    public CommandInitializer(final JavaPlugin plugin, final EssentialsManager essentialsManager) {
        ...
        plugin.getCommand("createkit").setExecutor((CommandExecutor) new CreateKitCMD(essentialsManager));
        plugin.getCommand("deletekit").setExecutor((CommandExecutor) new DeleteKitCMD(essentialsManager));
        ...
        plugin.getCommand("kit").setExecutor((CommandExecutor) new KitCMD(essentialsManager));
        plugin.getCommand("kitpreview").setExecutor((CommandExecutor) new KitPreviewCMD(server, essentialsManager));
